// ============================================================
// PAGE D'ACCUEIL — Recherche et filtrage des restaurants
// Les restaurants sont chargés depuis MongoDB par Django
// et affichés sous forme de cartes HTML.
// Le filtrage se fait côté client sans requête serveur.
// ============================================================

// Filtrer les cartes affichées selon les critères choisis
...
// Ouvrir/fermer une section de filtre
function basculerFiltre(header) {
    header.parentElement.classList.toggle('collapsed');
}

// Ajouter ou retirer un restaurant des favoris (appel API MongoDB)
...
// Vérifier l'état favori de chaque carte au chargement
